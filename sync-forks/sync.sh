...
python3 sync.py -f git@github.com:QubitPi/neo4j-graph-examples-movies.git               -u git@github.com:neo4j-graph-examples/movies.git               -ub main
...
python3 sync.py -f git@github.com:QubitPi/elastic-docs.git         -u git@github.com:elastic/docs.git         -ub master
...
python3 sync.py -f git@github.com:QubitPi/jakartaee-persistence.git       -u git@github.com:jakartaee/persistence.git                 -ub master
